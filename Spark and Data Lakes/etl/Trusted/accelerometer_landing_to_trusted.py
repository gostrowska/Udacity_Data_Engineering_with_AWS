...
'''
DropFields_node1748170437914 = sparkSqlQuery(glueContext, query = SqlQuery571, mapping = {"myDataSource":CustomerPrivacyFilter_node1748170414276}, transformation_ctx = "DropFields_node1748170437914")
...
AmazonS3_node1748170453009 = glueContext.getSink(path="s3://graza-bucket/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1748170453009")
AmazonS3_node1748170453009.setCatalogInfo(catalogDatabase="graza",catalogTableName="accelerometer_trusted")
